...
<!-----------------------HEARDER ----------------------------------------->
<header>
        <img src="/images/avt.png" class="logo" style="width:130px;"><!--LOGO -->
                ...
                if(isset($_SESSION['submit'])) {
                    $user_admin = $_SESSION['submit'];
                            if($user_admin == 'Admin_Chu') {
                                ...
                                <div class="logout">
                                <a href="/admin/login.php"><i class="fas fa-user-edit"></i>Admin</a> <br>                             
...
#banner2 {/* banner rồng*/
    width: 100%;
    background-image :url("banner rong2.jpg");
    background-size:cover;
