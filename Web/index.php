    ...
    <div id="new">
        ...
        <ul id="list-new">
            <div class="item"><!--sản phẩm 1 -->
                <img src="/images/new1.jpg"width="340" height="340"  alt="">                   
            ...
            <div class="item"><!--sản phẩm 2 -->
                <img src="/images/new2.jpg"width="340" height="340"  alt="">                   
            ...
            <div class="item"><!--sản phẩm 1 -->
                <img src="/images/new3.jpg"width="340" height="340"  alt="">                   
...
#banner1 {
    ...
    background-image :url("/images/banneronepiece.png");
...
#banner2 {/* banner rồng*/
    width: 100%;
    background-image :url("/images/banner rong2.jpg");
